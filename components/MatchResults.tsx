...
import { X, TrendingUp, CheckCircle, AlertCircle, AlertTriangle, Info } from "lucide-react";
...
export default function MatchResults({ dealName, matches, onClose, loading, dataQuality }: MatchResultsProps) {
  return (
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-4xl rounded-lg bg-white shadow-xl">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 p-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">VC Matches</h2>
              <p className="mt-1 text-sm text-gray-600">{dealName}</p>
            </div>
            <button
              onClick={onClose}
            ...
            {loading ? (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-sm text-gray-600">Analyzing matches with AI...</p>
              ...
              <div className="py-12 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Try adjusting the deal details or check size</p>
              ...
              <div className="space-y-4">
                {/* Data Quality Banner */}
                {dataQuality && (dataQuality.deal < 60 || dataQuality.partners < 60) && (
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="text-sm text-yellow-900">
                        ...
                        <p className="text-yellow-800 mb-2">
                          Deal quality: {dataQuality.deal}% | Partner avg quality: {dataQuality.partners}%
                        </p>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <div className="mt-1 flex flex-wrap gap-2 text-xs text-gray-600">
                          ...
                          <span>•</span>
                          <span>{match.investmentStage}</span>
                          <span>•</span>
                          <span>{match.investmentSpace}</span>
                        </div>
                      </div>
